...
- (void)profileSelection {
    [[NSNotificationCenter defaultCenter] postNotificationName:kShowUserDataScreenNotification object:@{@"animated":[NSNumber numberWithBool:YES]}];
}
- (void)myAddressesSelection {
    [[NSNotificationCenter defaultCenter] postNotificationName:kShowCheckoutAddressesScreenNotification object:@{@"animated":[NSNumber numberWithBool:NO]} userInfo:@{@"from_checkout":[NSNumber numberWithBool:NO]}];
}

- (void)emailNotificationSelection {
    [[NSNotificationCenter defaultCenter] postNotificationName:kShowEmailNotificationsScreenNotification object:@{@"animated":[NSNumber numberWithBool:YES]}];
}
...
- (void)shareTheAppSelection {
    ...
    if(UIUserInterfaceIdiomPad == UI_USER_INTERFACE_IDIOM()) {
        CGRect sharePopoverRect = CGRectMake(self.view.frame.size.width / 2,
                                             self.view.frame.size.height - 6.0f,
                                             0.0f,
                                             0.0f);
