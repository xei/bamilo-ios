...
#define STRING_FORGET_PASS RILocalizedString(@"forget_pass", nil)
...
#define STRING_LOADING RILocalizedString(@"Loading", nil)
...
#define STRING_SELLER_DELIVERTY_TIME_INFO RILocalizedString(@"seller_information", nil)
...
#define STRING_ON RILocalizedString(@"on_label", nil)
...
#define STRING_SUBCATEGORIES RILocalizedString(@"subcategories", nil)
...
#define STRING_SERVER_ERROR_MESSAGES RILocalizedString(@"server_error_message", nil)
#endif
