...
//    
//    [attributes setObject:searchTarget.targetType == CATALOG_CATEGORY ? searchTarget.node : cUNKNOWN_EVENT_VALUE forKey: kEventCategoryUrlKey];
//    [attributes setObject:searchTarget.targetType == CATALOG_CATEGORY ? searchTarget.node :cUNKNOWN_EVENT_VALUE forKey:kEventKeywords];
//    
//    [attributes setObject:@"Catalog" forKey: kGAEventCategory];
//    [attributes setObject:@"Search" forKey:kGAEventActionName];
//    [attributes setObject:searchTarget.type forKey:kGAEventLabel];
//    [attributes setObject:searchTarget.node forKey:kGAEventValue];
//    
//    return attributes;
//}
