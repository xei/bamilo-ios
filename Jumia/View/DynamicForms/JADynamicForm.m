...
-(NSDictionary*)getValues
{
    ...
    if(VALID_NOTEMPTY(self.formViews, NSMutableArray))
    {
        ...
        {
            if ([view isKindOfClass:[JARadioExpandableComponent class]]) {
                JARadioExpandableComponent* radioExpandable = (JARadioExpandableComponent*) view;
                if (VALID_NOTEMPTY([radioExpandable getValues], NSDictionary)) {
                    [parameters addEntriesFromDictionary:[radioExpandable getValues]];
                }
