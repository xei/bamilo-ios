...
NSString *const RI_API_SET_BILLING_ADDRESS = @"multistep/billing/";
NSString *const RI_API_GET_SHIPPING_ADDRESS_FORM = @"multistep/shipping/";
NSString *const RI_API_SET_SHIPPING_ADDRESS = @"multistep/shipping/";
NSString *const RI_API_GET_SHIPPING_METHODS_FORM = @"multistep/shippingmethod/";
NSString *const RI_API_SET_SHIPPING_METHOD = @"multistep/shippingmethod/";
NSString *const RI_API_GET_PAYMENT_METHODS_FORM = @"multistep/paymentmethod/";
NSString *const RI_API_SET_PAYMENT_METHOD = @"multistep/paymentmethod/";