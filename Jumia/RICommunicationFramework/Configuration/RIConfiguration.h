...
FOUNDATION_EXPORT NSString *const RI_API_SET_BILLING_ADDRESS;
FOUNDATION_EXPORT NSString *const RI_API_GET_SHIPPING_ADDRESS_FORM;
FOUNDATION_EXPORT NSString *const RI_API_SET_SHIPPING_ADDRESS;
FOUNDATION_EXPORT NSString *const RI_API_GET_SHIPPING_METHODS_FORM;
FOUNDATION_EXPORT NSString *const RI_API_SET_SHIPPING_METHOD;
FOUNDATION_EXPORT NSString *const RI_API_GET_PAYMENT_METHODS_FORM;
FOUNDATION_EXPORT NSString *const RI_API_SET_PAYMENT_METHOD;
