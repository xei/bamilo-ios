...
FOUNDATION_EXPORT NSString *const RI_UNIQUE_COUNTRY_URL_BAMILO_INTEGRATION;
...
FOUNDATION_EXPORT NSString *const RI_API_GET_CUSTOMER_SELECT_DEFAULT_SHIPPING_ADDRESS;
FOUNDATION_EXPORT NSString *const RI_API_GET_CUSTOMER_SELECT_DEFAULT_BILLING_ADDRESS;
