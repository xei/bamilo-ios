...
Here is the list of the required/optional subviews of each message type :
 ...
 <td><u>Text label</u> : <b>UILabel</b> with tag <i>BMA4SInAppOverlayViewBodyTag</i></td>
 <td><u>Close button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewCloseTag</i> </td>
 </tr>
 <tr>
 <td rowspan="8">BMA4SInAppWebMessage</td>
 <td rowspan="8"><u>Web view</u> : <b>UIWebView</b> with tag <i>BMA4SInAppOverlayViewBodyTag</i></td>
 <td><u>Close button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewCloseTag</i></td>
 </tr>
 <tr>
 <td><u>Go Back Button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewBackTag</i></td>
 </tr>
 <tr>
 <td><u>Go Forward Button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewForwardTag</i></td>
 </tr>
 <tr>
 <td><u>Reload Button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewReloadTag</i></td>
 </tr>
 <tr>
 <td><u>Stop loading Button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewStopTag</i></td>
 </tr>
 <tr>
 <td><u>Open in Safari Button</u> : <b>UIButton</b> with tag <i>BMA4SInAppOverlayViewSafariTag</i></td>
 </tr>
 <tr>
 <td><u>Loader</u> : <b>UIActivityIndicatorView</b> with tag <i>BMA4SInAppOverlayViewActivityTag</i></td>
 </tr>
 <tr>
 <td><u>Toolbar</u> : <b>UIToolbar</b> with tag <i>BMA4SInAppOverlayViewToolbarTag</i></td>
 </tr>
 </table>
...
/**
 Tells that a specified inApp is about to be displayed.
 
 This method can be used to apply a custom displaying animation to an inApp
...
/**
 *  Tells that the specified inapp is now displayed.
 *
 *  @param message The object containing the inapp informations
 *  @param view    The inapp view
 *  @since Available in SDK 5.3.0 and later.
