...
@objc class AddressDataManager: DataManager {
    ...
    func getUserAddressList(_ target:DataServiceProtocol, completion: @escaping DataCompletion) {
    ...
    func setDefaultAddress(_ target: DataServiceProtocol, address: Address, isBilling: Bool, completion: @escaping DataCompletion) {
    ...
    func getRegions(_ target: DataServiceProtocol, completion:@escaping DataCompletion) {
        self.getAreaZone(target, type: .background, path: RI_API_GET_CUSTOMER_REGIONS, completion: completion)
    }
    
    func getCities(_ target: DataServiceProtocol, regionId:String, completion:@escaping DataCompletion) {
    ...
    func getVicinity(_ target: DataServiceProtocol, cityId: String, completion:@escaping DataCompletion) {
        let path = "\(RI_API_GET_CUSTOMER_POSTCODES)city_id/\(cityId)"
        self.getAreaZone(target, type: .background, path:path, completion: completion)
    }
    
    //MARK: - Address CRUD
    func addAddress(_ target: DataServiceProtocol, params: [String:String], completion:@escaping DataCompletion) {
    ...
    func updateAddress(_ target: DataServiceProtocol, params: [String:String], id: String, completion:@escaping DataCompletion) {
    ...
    func getAddress(_ target: DataServiceProtocol, id: String, completion:@escaping DataCompletion) {
    ...
    // MARK: - Helpers
    private func getAreaZone(_ tagret: DataServiceProtocol, type: RequestExecutionType, path: String, completion:@escaping DataCompletion) {
