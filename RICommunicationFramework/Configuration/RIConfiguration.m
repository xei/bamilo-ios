...
NSString *const RI_API_VERSION = @"v2.8/"; // ||| DO NOT CHANGE |||
...
NSString *const RI_API_CANCEL_ORDER = @"customer/cancelitems";
...
NSString *const RI_API_PHONE_VERIFY = @"customer/verifymobile/";
...
NSString *const RI_API_INTERNAL_LINKS = @"main/getinternallinks/";
